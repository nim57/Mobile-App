  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      bottomNavigationBar: Obx(
          ...
          indicatorColor: darkmode ? EColor.white.withOpacity(0.1) : EColor.black.withOpacity(0.1),
          destinations: const [
            NavigationDestination(icon: Icon(Iconsax.home), label: 'Home'),
            NavigationDestination(icon: Icon(Iconsax.message_add), label: 'New Post'),
...
class NavigationController1 extends GetxController{
  ...
  final screen = [ const HomeScreen(), const AddNewPost(), const LoginScreen(), const SettingScreen(),];
